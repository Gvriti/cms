...
<li id="item{{$model->id}}" data-id="{{$model->id}}" data-pos="{{$model->position}}" data-url="{{cms_route('slider.edit', [$model->id])}}" class="item col-md-3 col-sm-4 col-xs-6">
    <div class="album-image">
        ...
        <div class="image-options">
            <a href="#" data-url="{{cms_route('slider.visibility', [$model->id])}}" class="visibility">
