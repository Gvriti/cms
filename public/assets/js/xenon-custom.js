...
//////////////////////////////////////////////////////
// Handle a lockscreen requests to the application. //
//////////////////////////////////////////////////////
var timer;
...
function detectFormChanges() {
    var inputsOld = [];
    var hiddenSelector = ':not([type="hidden"])';
    $('form.detect-changes').each(function() {
        var input = $(hiddenSelector, this);
        var lang = $(this).data('lang');
        inputsOld[lang] = input.serialize();
    });
    $('form.detect-changes').on('submit', function() {
        var lang = $(this).data('lang');
        var inputsNew = $(hiddenSelector, this).serialize();
        if (inputsOld[lang] != inputsNew) {
            $('#form-changes-' + lang, this).val(1);
        } else {
            $('#form-changes-' + lang, this).val(0);
        }
        inputsOld[lang] = inputsNew;
    });
}
